...
export const herokuSkill = { id: B_HEROKU, image: "", label: "Heroku" };
...
export const NNSkill = { id: D_NN, image: "", label: "Neural Networks" };

export const shinySkill = { id: D_SHINY, image: "", label: "R Shiny" };
